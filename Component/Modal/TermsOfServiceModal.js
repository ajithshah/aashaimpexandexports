      ...
      <div className={styles.modalContent}>
        ...
        <div className={styles.modalBody}>
          <div className={styles.policyContent}>
            ...
            <p>
              By accessing and using A A Sha Impex and Exports website and
            ...
            <h3>3. Services</h3>
            <p>
              Our services include import-export consultation, logistics
              support, trade documentation, and related business services. All
              services are provided subject to availability and our standard
            ...
            <ul>
              ...
              <li>
                Not engage in any activity that could harm our business or
                reputation
              </li>
            ...
            <p>
              In no event shall A A Sha Impex and Exports be liable for any
              damages arising out of the use or inability to use our website or
              services. We shall not be liable for any indirect, special,
            ...
            <p>
              ...
              Phone: +91 8879811876
              <br />
              Address: F8, First floor, Washington plaza, Mumbai - 400104
              (INDIA)
            </p>
